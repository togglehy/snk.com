...
class content_finder_indexs
{
    ...
    public function column_edit($row)
    {
        ...
        return $_return.'<a class="btn btn-xs btn-default" href="'.app::get('site')->router()->gen_url(array('app' => 'content', 'ctl' => 'site_article', 'act' => 'index', 'arg0' => $row['article_id'])).'" target="_blank" ><i class="fa fa-eye"></i>'.'预览'.'</a>';
    }
