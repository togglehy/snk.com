...
class desktop_ctl_system extends desktop_controller{
    ...
    function set_title(){
        ...
        echo '<h4 class="head-title" >'.'标题设置'.'</h4>';
            ...
            $html .= $this->ui()->form_input(array('title'=>'标题：','name'=>'background.title','tab'=>'后台设置','value'=>$background_title,'vtype'=>'required'));
    ...
    {
        echo '<h4 class="head-title" >'.'系统配置'.'</h4>';
       if($_POST){
        ...
        if($select === 'true'){
             ...
             $html .="<tr><th><label>".'后台登录启用验证码'."</label></th><td>&nbsp;&nbsp;<select name='shopamin_vocde' type='select' ><option value='true' selected='selected'>".'是'."</option><option value='false' >".'否'."</option></select></td></tr>";

        }
        else{

             $html .="<tr><th><label>".'后台登录启用验证码'."</lable></th><td>&nbsp;&nbsp;<select name='shopamin_vocde' type='select' ><option value='true'>".'是'."</option><option value='false' selected='selected'>".'否'."</option></select></td></tr>";
