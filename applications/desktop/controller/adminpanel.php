...
class desktop_ctl_adminpanel extends desktop_controller {
    ...
    function index() {
        ...
        if ($user->is_super()) {
            $list = app::get('desktop')->model('menus')->getlist('app_id,menu_title,addon,menu_path', array(
                'menu_type' => 'panelgroup',
                'disabled' => 'false'
            ));
            $pers = $menus->getList('permission', array(
            ...
            $list = app::get('desktop')->model('menus')->getlist('app_id,menu_title,menu_path,permission', array(
                'menu_type' => 'adminpanel',
                'disabled' => 'false',
                'display' => 'true',
            ));
            foreach ($list as $row) {
                if (!in_array($row['permission'], (array)$aper)) continue;
            ...
            $adminpanel = app::get('desktop')->model('menus')->getlist('app_id,menu_title,menu_path', array(
                'menu_type' => 'adminpanel',
                'disabled' => 'false',
                'permission' => $aPer,
                'display' => 'true',
            ...
            foreach ($list as $key => $val) {
                ...
                if (in_array($fag, $aTitle)) $list_bak[] = $val;
            }
            $group = array();
            ...
            $list = app::get('desktop')->model('menus')->getlist('app_id,menu_title,menu_path', array(
                'menu_type' => 'adminpanel',
                'disabled' => 'false',
                'permission' => $aPer,
                'display' => 'true',
