...
class desktop_finder_recycle{
    ...
    function __construct($app){
        ...
        $this->actions  = array(
            ...
            array('label'=>'恢复所选','icon'=>'del.gif','submit'=>'index.php?app=desktop&ctl=recycle&act=recycle_processtype','target'=>'dialog::{title:\''.'恢复所选'.'\',width:400,height:300}'),
    ...
    function detail_basic($id){
        ...
        $format_time = $this->app->getConf('format_time');
