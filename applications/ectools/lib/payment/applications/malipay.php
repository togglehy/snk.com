...
final class ectools_payment_applications_malipay extends ectools_payment_parent implements ectools_payment_interface
{
    public $name = '支付宝即时到账手机版';
    public $version = 'v1.0';
    public $intro = '支付宝www.alipay.com即时到账手机版交易接口(alipay.wap.create.direct.pay.by.user)';
    ...
    public function __construct($app)
    {
        ...
        $this->callback_url = vmc::openapi_url('openapi.ectools_payment', 'getway_callback', array(
            'ectools_payment_applications_malipay' => 'callback',
        ));
        $this->notify_url = vmc::openapi_url('openapi.ectools_payment', 'getway_callback', array(
            'ectools_payment_applications_malipay' => 'notify',
        ));
