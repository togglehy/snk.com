...
class ectools_finder_currency extends desktop_controller
{
    ...
    {
        return '<a href="index.php?app=ectools&ctl=currency&act=showEdit&cur_id='.$row['cur_id'].'&_finder[finder_id]='.$_GET['_finder']['finder_id'].'&finder_id='.$_GET['_finder']['finder_id'].'" target="dialog::{title:\''.'编辑货币信息'.'\',width:700,height:300}"><span>'.'编辑'.'</span></a>';
    }
}
