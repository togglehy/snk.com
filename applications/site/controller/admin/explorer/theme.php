...
class site_ctl_admin_explorer_theme extends site_admin_controller
{
    ...
    {
        return vmc::singleton('site_theme_file')->get_theme_dir($theme, $open_path);
    }//End Function
    ...
    public function directory()
    {
        ...
        $this->pagedata['list'] = vmc::singleton('site_theme_tmpl')->get_edit_list($theme);
        ...
        $this->pagedata['types'] = vmc::singleton('site_theme_tmpl')->get_name();
        ...
        if (!$open_path && !$is_part) {
            ...
            echo $this->fetch('admin/explorer/theme/theme_directory_body.html');
            exit;
        }
    }//End Function
    ...
    private function get_directory_body($theme = '', $open_path = '', $msg = '', $act = '')
    {
        ...
        $fileObj = vmc::singleton('site_explorer_file');
    ...
    public function detail()
    {
        ...
        $get_file = vmc::singleton('site_theme_file')->get_file($dir, $file_name);
        ...
        if (in_array($filenameInfo['extension'], array('css', 'html', 'js', 'xml'))) {
            if ($filenameInfo['extension'] == 'css') {
                $file_content = vmc::singleton('site_theme_file')->get_content($file_content);
            }
            ...
            $this->pagedata['file_url'] = vmc::singleton('site_theme_file')->get_full_file_url($theme, $file_content, $open_path, $file_name);
    ...
    public function svae_source()
    {
        ...
        $fileObj = vmc::singleton('site_explorer_file', $theme);
        $fileObj->set_theme($theme);
        $dir = $this->get_theme_dir($theme, $open_path);
    ...
    public function save_image()
    {
        ...
        $file_name = vmc::singleton('site_theme_file')->get_file($dir, $file_name);
