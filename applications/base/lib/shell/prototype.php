...
class base_shell_prototype
{
    ...
    public function get_option($item)
    {
    ...
    public function exec($command_parts)
    {
    ...
    public function get_options_define($action)
    {
    ...
    public function register_trigger($trigger)
    {
    ...
    public static function output_table($rows, $cellspace_max = array())
    {
        $out = array();
        foreach ($rows as $i => $r) {
            foreach ($r as $k => $v) {
    ...
    public static function output_line($string = null)
    {
        echo "\n".str_pad(($string?$string.' ':''),self::shell_width(), "-")."\n";
    }

    public static function shell_width()
    {
