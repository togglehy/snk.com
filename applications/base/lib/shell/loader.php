...
class base_shell_loader
{
    ...
    public function &get_commander($app_id, $shell_command)
    {
    ...
    public function input_option($options, $part, $message = null)
    {
    ...
    public function save_input_option($options, $map, $input, $part)
    {
        if ($input == '#') {
            return false;
        } else {
    ...
    public function exec_command($line)
    {
        $this->exec($line);
    }
