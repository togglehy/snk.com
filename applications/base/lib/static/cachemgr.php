...
class cachemgr
{
     ...
     * @access static private
     */
    private static $_cache_objects_exists = array();

    /*
     * @var string $_cache_check_version_key
     * @access static private
     */
    private static $_cache_check_version_key = '__CACHEMGR_CACHE_CHECK_VERSION_KEY__';

    /*
     * @var string $_cache_check_version
     * @access static private
     */
    private static $_cache_check_version = null;
     ...
     * @access static private
     */
    private static $_cache_expirations = array();
     ...
     * @return mixed
     */
    public static function get_modified($type, $vary_key)
    {
     ...
     * @return void
     */
    public static function set_expiration($time)
    {
     ...
     * @return void
     */
    private static function update_expiration($time, $level)
    {
        if ($time > 0) {
     ...
     * @return void
     */
    private static function update_parents_expiration($time)
    {
     ...
     * @return boolean
     */
    public static function get($key, &$return, $skipvary = false)
    {
     ...
     * @return boolean
     */
    public static function set($key, $content, $params = array())
    {
     ...
     * @return mixed
     */
    public static function exec($func, $args, $ttl = 3600)
    {
        if (is_array($func)) {
            $key = self::get_key('CACHEMGR_PREFIX'.'_CLASS_'.get_class($func[0]).'_FUNC_'.serialize($func[1]).'_PARAMS_'.serialize($args));
        } else {
            $key = self::get_key('CACHEMGR_PREFIX'.'_FUNC_'.$func.'_PARAMS_'.serialize($args));
        }
     ...
     * @return string
     */
    public static function get_cache_check_version()
    {
     ...
     * @return string
     */
    public static function get_cache_global_varys()
    {
        //引响全局的vary
     ...
     * @return string
     */
    public static function get_cache_check_version_key()
    {
     ...
     * @return void
     */
    public static function co_start()
    {
     ...
     * @return void
     */
    public static function check_expires($type, $cache_name)
    {
     ...
     * @return int
     */
    public static function check_current_co_depth()
    {
     ...
     * @return boolean
     */
    public static function optimize(&$msg)
    {
    ...
    public static function clean(&$msg)
    {
        ...
        if ($res) {
            foreach (vmc::servicelist('base_cachemgr_clean') as $service) {
