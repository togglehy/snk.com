...
class base_cache_filesystem_model extends base_cache_abstract
{
    public $idx_node_size = 40;
    public $data_core_pos = 262588; //40+20+24*16+16*16*16*16*4;
    ...
    public function _format($truncate = false)
    {
        if ($this->lock(true, true)) {
            ...
            $this->max_size = $this->_parse_str_size(FILESYSTEM_CACHE_MAX, 15728640); //default:15m
